    ...
    const NFTsMarketPageOneColumnone = (props) => {
  ...
  >{props?.2000000eth}</Text></div></div></div></div></>);
    ...
    NFTsMarketPageOneColumnone.defaultProps = {one: "#1", boredapeyatch: "Bored Ape Yatch Club", 2000000eth: "20.00000ETH"};
  

    export default NFTsMarketPageOneColumnone;
