...
import NFTsMarketPageOneColumnThirtySeven from "components/NFTsMarketPageOneColumnThirtySeven";
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-ubuntu items-center justify-start mx-auto w-full">
          ...
          <div className="flex md:flex-1 md:flex-col flex-row gap-12 items-center justify-start mb-[9px] ml-24 md:ml-[0] md:mt-0 mt-10 w-auto md:w-full">
            ...
            <div className="flex flex-col gap-10 items-start justify-start w-auto sm:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 gap-16 items-start justify-start w-auto sm:w-full">
                <Button className="bg-transparent cursor-pointer font-medium min-w-[45px] py-0.5 text-base text-center text-gray-900 tracking-[0.08px]">
                  Home
                </Button>
                ...
                <Button className="bg-transparent cursor-pointer font-medium min-w-[51px] py-0.5 text-base text-center text-gray-900 tracking-[0.08px]">
                  Trades
                </Button>
                <Button className="bg-transparent cursor-pointer font-medium min-w-[69px] py-0.5 text-base text-center text-gray-900 tracking-[0.08px]">
                  About Us
                </Button>
                <Button className="bg-transparent cursor-pointer font-medium min-w-[39px] py-0.5 text-base text-center text-gray-900 tracking-[0.08px]">
                  FAQs
                </Button>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-10 items-start justify-start max-w-[1220px] mt-[87px] mx-auto md:px-5 w-full">
          <Text
        ...
        <div className="flex flex-col gap-10 items-start justify-start max-w-[1234px] mt-16 mx-auto md:px-5 w-full">
          <Text
            className="capitalize text-gray-900 text-xl tracking-[0.10px] w-auto"
            size="txtUbuntuBold20Gray900"
          >
          ...
          <div className="flex flex-col items-start justify-start w-auto md:w-full">
            <div className="md:gap-5 gap-8 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
              {new Array(9).fill({}).map((props, index) => (
                <React.Fragment
                  key={`NFTsMarketPageOneColumnThirtySeven${index}`}
                >
                  <NFTsMarketPageOneColumnThirtySeven
        ...
        <Footer className="bg-white-A700 flex items-center justify-center mt-[217px] md:px-5 w-full" />
      </div>
    </>
  );
};
