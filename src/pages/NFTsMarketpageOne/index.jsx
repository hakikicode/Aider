...
import NFTsMarketPageOneColumnrectangle131 from "components/NFTsMarketPageOneColumnrectangle131";

const NFTsMarketpageOnePage = () => {
  const navigate = useNavigate();

  const nfTsMarketPageOneColumnrectangle131PropList = [
    {},
    { tokensnft: "PepeRock" },
          ...
          <div className="flex flex-col md:gap-10 gap-16 items-start justify-start w-auto md:w-full">
            ...
            <div className="flex flex-col items-end justify-start w-auto md:w-full">
              <div className="gap-24 md:gap-5 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
                {nfTsMarketPageOneColumnrectangle131PropList.map(
                  (props, index) => (
                    <React.Fragment
                      key={`NFTsMarketPageOneColumnrectangle131${index}`}
                    >
                      <NFTsMarketPageOneColumnrectangle131
...
export default NFTsMarketpageOnePage;
